...
export function AboutPage() {
  ...
  return (
    <div className="pt-16 bg-white dark:bg-slate-950 overflow-hidden transition-colors duration-500">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl lg:text-6xl text-white brand-font tracking-tight">
              About <span className="text-amber-500 italic">Lahori Samosa</span>
            </h1>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="space-y-6">
                <h2 className="text-3xl text-white brand-font">Our Story</h2>
              ...
              <Link to="/products" className="inline-block mt-8">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="group px-8 py-4 bg-amber-500 text-slate-900 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:bg-amber-400"
                >
      ...
      {/* Our Values */}
      <section className="py-24 bg-white dark:bg-slate-950 relative transition-colors duration-500">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl text-slate-900 dark:text-white brand-font">Our Values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                className="group text-center p-8 bg-white dark:bg-slate-900 rounded-xl hover:shadow-2xl transition-all duration-300 border border-slate-100 dark:border-slate-800"
                style={{
              ...
              >
                ...
                <h3 className="text-lg text-slate-900 dark:text-white mb-4 group-hover:text-amber-800 dark:group-hover:text-amber-400 transition-colors">
                  {value.title}
                </h3>
      ...
      <section className="py-24 bg-gradient-to-br from-slate-50 to-gray-50 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-amber-100/40 to-transparent rounded-full blur-3xl"></div>
            ...
            {team.map((member, index) => (
              ...
              >
                ...
                <div className="p-6 space-y-3">
                  <h3 className="text-xl text-slate-900 group-hover:text-amber-800 transition-colors">
                    {member.name}
                  </h3>
      ...
      <section className="py-24 bg-white dark:bg-slate-950 transition-colors duration-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          <motion.div
            ...
            className="space-y-4"
          >
            <h2 className="text-4xl text-slate-900 dark:text-white brand-font">Ready to Taste the Difference?</h2>
